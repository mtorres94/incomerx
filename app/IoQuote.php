...
class IoQuote extends Model
{
    ...
    {
        return $this->hasMany('Sass\IoQuoteCargo', 'quotes_id');
    }
    public function origin_charge()
    {
        return $this->hasMany('Sass\IoQuoteCharge', 'quotes_id');
    }
