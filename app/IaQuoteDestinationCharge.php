...
class IaQuoteDestinationCharge extends Model
{
    ...
    {
        return $this->belongsTo('Sass\BillingCode', 'billing_currency_type');
    }
    public function cost_currency()
    {
        return $this->belongsTo('Sass\BillingCode', 'cost_currency_type');
    }
