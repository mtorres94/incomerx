...
class BillOfLading extends Model
{
    ...
    public static function saveDetail($id, $data)
    {
        ...
        if (isset($data['resume_line'])) {
            $details = DB::table('exp_bills_of_lading')->where('bill_of_lading_id', '=', $data['bill_of_lading_id'])->delete();
                while ($a < count($data['resume_line'])) {
                    ...
                    if (isset($data['resume_line'][$i])) {
                        ...
                        $obj = [
                            ...
                            'total_weight_kgs'=> $data['resume_gross_weight'][$i],
                            'total_cubic_cbm'=> $data['resume_cubic'][$i],
                            'total_charge_weight_kgs'=> $data['resume_charge_weight'][$i],

                        ];
                        $id_hbl = BillOfLading::create($obj)->id;
                ...
                BillOfLadingCargo::saveDetailHBL($data);
                EoHblReceiptEntry::saveDetail($data);
    ...
    {
        return $this->belongsTo('Sass\CargoLoader', 'cargo_loader_id');
    }
