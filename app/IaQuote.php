...
class IaQuote extends Model
{
    ...
    {
        return $this->hasMany('Sass\IaQuoteCargo', 'quotes_id');
    }
    public function charge()
    {
        return $this->hasMany('Sass\IaQuoteCharge', 'quotes_id');
    }
}
