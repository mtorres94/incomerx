...
class IaQuote extends Model
{
    ...
    {
        return $this->belongsTo('Sass\Airport', 'transhipment_port_id');
    }
    ...
    {
        return $this->hasMany('Sass\IaQuoteCargo', 'quote_id');
    }
    public function origin_charge()
    {
        return $this->hasMany('Sass\IaQuoteOriginCharge', 'quote_id');
    }
    public function destination_charge()
    {
        return $this->hasMany('Sass\IaQuoteDestinationCharge', 'quote_id');
    }
}
