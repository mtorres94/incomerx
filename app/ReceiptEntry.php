...
class ReceiptEntry extends Model
{
    ...
    protected $fillable = [
        ...
        'sum_bill', 'sum_profit', 'sum_cost', 'sum_profit_percent', 'bill_of_lading_id', 'is_hazardous','location_destination_code', 'ea_loading_guide_id', 'ea_airwaybill_id', 'line'
    ];
    ...
    {
        return $this->belongsTo('Sass\EaAirwayBill', 'ea_airwaybill_id');
    }
}
