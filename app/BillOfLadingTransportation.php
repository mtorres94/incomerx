...
class BillOfLadingTransportation extends Model
{
    protected $table = "exp_bill_of_lading_transportation";
    ...
    public static function saveDetail($id, $data) {
        ...
        if (isset($data['transportation_id'])){
            $details= DB::table('exp_bill_of_lading_transportation')->where('bill_of_lading_id', '=', $id)->delete();
            while($a < count($data['transportation_id'])){
                $i++;
                if (isset($data['transportation_id'][$i])){
                    $obj = new BillOfLadingTransportation();
