<div class="row ">
    ...
    <div class="col-md-3">{!! Form::bsSelect(null, null, 'Unit','cost_unit_id',  Sass\Unit::all()->lists('code', 'id'), 'Units', 'body', false) !!}</div>
...
<div class="row">
    <div class="col-md-4">{!! Form::bsComplete(null, null, 'Vendor', 'billing_vendor_code', 'billing_vendor_name', Request::get('term'),
   null, 'Vendors...') !!}</div>
    <div class="col-md-2">{!! Form::bsDate(null, null, 'Date', 'cost_date', null, '') !!}</div>
    <div class="col-md-3">{!! Form::bsText(null, null, 'Invoice #', 'cost_invoice', null, '') !!}</div>
    <div class="col-md-3">{!! Form::bsText(null, null, 'Reference #', 'cost_reference', null, '') !!}</div>
