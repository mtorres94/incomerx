...
$("#partner_name").marcoPolo({url:"{{ route('customers.autocomplete') }}",formatItem:function(e,o){return e.value},onSelect:function(e,o){$("#partner_id").val(e.id),$(this).val(e.value)},minChars:3,param:"term"}).on("marcopolorequestbefore",function(){$("#partner_name_img").removeClass("img-none").addClass("img-display"),$("#partner_name_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#partner_name_img").removeClass("img-display").addClass("img-none"),$("#partner_name_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#partner_id").val(0)}).blur(function(){var e=$("#partner_id").val();0==e&&($(this).val(""))});
