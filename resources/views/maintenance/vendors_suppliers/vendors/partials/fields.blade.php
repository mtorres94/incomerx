<div class="container-fluid">
    <div class="col-md-6">
        {!! Form::bsText('col-md-4', 'col-md-8', 'Code', 'code', null, 'Enter the name for the vendor') !!}
        ...
        {!! Form::bsComplete('col-md-4', 'col-md-8', 'State', 'state_id', 'state_name', Request::get('term'),
        ((isset($vendor) and $vendor->state_id > 0) ? $vendor->state->name : null)
        , 'States...', 'options.maintenance.countries.states', 'options.maintenance.countries.states', 'maintenance.countries_destinations.states.index') !!}
    ...
    <div class="col-md-6">
        ...
        {!! Form::bsSelect('col-md-4', 'col-md-8', 'Currency', 'currency_id', Sass\Currency::all()->lists('name', 'id'), 'Choose one of the following currencies') !!}
        ...
        <div id="subpanel" class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row no-padding-top">
                    <div class="col-md-6">{!! Form::bsCheck('Airline', 'airline') !!}</div>
                    <div class="col-md-6">{!! Form::bsCheck('Agent', 'agent') !!}</div>
                </div>
                <div class="row no-padding-top">
                    <div class="col-md-6">{!! Form::bsCheck('Ocean Carrier', 'ocean_carrier') !!}</div>
                    <div class="col-md-6">{!! Form::bsCheck('Other', 'other') !!}</div>
                </div>
                <div class="row no-padding-top">
                    <div class="col-md-6">{!! Form::bsCheck('Truck', 'truck') !!}</div>
                </div>
            </div>
        </div>
        <div id="subpanel" class="panel panel-default">
