        ...
        <div class="easyui-tabs" id="quotes_tabs">
                ...
                <div class="form-horizontal">
                    <div class="col-md-12">
                        <div style="padding-top: 10px;padding-bottom: 15px;">
                            <div class="col-md-6">@include('import.oceans.quotes.partials.sections.customer')</div>
                            <div class="col-md-6">@include('import.oceans.quotes.partials.sections.agent')</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div title="Shipper / Consignee">
                <div class="form-horizontal">
                    <div class="col-md-12">
                        <div style="padding-top: 10px;padding-bottom: 15px;">
                            <div class="col-md-6">@include('import.oceans.quotes.partials.sections.shipper')</div>
                            <div class="col-md-6">@include('import.oceans.quotes.partials.sections.consignee')</div>
...
<div class="row">
    <div class="col-md-12">
        @include('import.oceans.quotes.partials.sections.cargo_details')
    </div>
</div>
<div class="row">
    @include('import.oceans.quotes.partials.sections.charge_details')
</div>
<div class="row">
...
<!-- Modal forms section -->
@section('modals')
    @include('import.oceans.quotes.partials.modal.cargo_details')
...
@section('scripts')
    ...
    @include('import.oceans.quotes.partials.scripts.init')
    @include('import.oceans.quotes.partials.scripts.compute')
