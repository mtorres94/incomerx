...
<div class="row">
    <div class="col-md-12">    {!! Form::bsComplete('col-md-3', 'col-md-9', 'Transhipment Port', 'transhipment_port_id', 'transhipment_port_name', Request::get('term'), ((isset($quotes) and $quotes->transhipment_port_id > 0) ? $quotes->transhipment_port->name : null), 'Ocean Ports') !!}</div>
</div>
<div class="row">
