...
<div class="row row-padding">
    <div class="col-md-12">
        ...
        <div class="col-md-3">{!! Form::bsComplete(null, null, 'Cargo Type', 'total_cargo_type_id', 'total_cargo_type_code', Request::get('term'), ((isset($quotes) and $quotes->total_cargo_type_id > 0) ? $quotes->total_cargo_type->name : null), null) !!}</div>
