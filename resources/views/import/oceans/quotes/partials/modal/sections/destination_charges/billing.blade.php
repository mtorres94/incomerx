<div class="row">
    ...
    <div class="col-md-2">{!! Form::bsText(null, null, 'Qty.', 'dest_billing_quantity', null, '0') !!}</div>
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Currency', 'dest_billing_currency_type',Sass\Currency::all()->lists('code', 'id'), '', 'body', false)
     !!}</div>
