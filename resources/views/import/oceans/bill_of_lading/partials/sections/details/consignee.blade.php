<fieldset id="Consignee">
    ...
    <div class="row">
        <div class="col-md-12">{!! Form::bsComplete('col-md-3', 'col-md-9', 'Zip Postal Code', 'consignee_zip_code_id', 'consignee_zip_code_code', Request::get('term'), ((isset($bill_of_lading) and $bill_of_lading->consignee_zip_code_id > 0) ? $bill_of_lading->consignee_zip_code->code : null), 'Zip Code') !!}</div>
    </div>
    <div class="row">
