<div id="Origin_Charges" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <form id="OriginModal" method="post">
            ...
            <div class="modal-body">
                ...
                <div id="origin-tabs" class="easyui-tabs">
                    <div title="Billing">
                        @include('import.oceans.bill_of_lading.partials.modal.sections.origin_charge.billing')
                    </div>
                    <div title="Cost">
                        @include('import.oceans.bill_of_lading.partials.modal.sections.origin_charge.cost')
                    </div>
                </div>
            </div>
