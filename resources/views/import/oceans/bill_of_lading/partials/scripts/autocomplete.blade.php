<script type="text/javascript">
    ...
    $("#tmp_drop_type").change(function () {
        ...
        $("#origin_billing_code").marcoPolo({url:"{{ route('billing_codes.autocomplete') }}",formatItem:function(e,o){return e.id + '|'+ e.code},onSelect:function(e,o){$("#origin_billing_id").val(e.id),$(this).val(e.code), $("#origin_billing_description").val(e.name)},minChars:2,param:"term"}).on("marcopolorequestbefore",function(){$("#origin_billing_code_img").removeClass("img-none").addClass("img-display"),$("#origin_billing_code_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#origin_billing_code_img").removeClass("img-display").addClass("img-none"),$("#origin_billing_code_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#origin_billing_id").val(0)}).blur(function(){var e=$("#origin_billing_id").val();0==e&&($(this).val(""),$("#origin_billing_description").val(""))});
