<script type="text/javascript">
    ...
    $("#total_commodity_name").marcoPolo({url:"{{ route('commodities.autocomplete') }}",formatItem:function(e,o){return e.name},selected:{
        ...
        name: '{{ ((isset($bill_of_lading) and ($bill_of_lading->total_commodity_id > 0 ))? $bill_of_lading->total_commodity->name : "") }}',
    ...
    $("#total_cargo_type_name").marcoPolo({url:"{{ route('cargo_types.autocomplete') }}",formatItem:function(e,o){return e.code},selected:{
        id: '{{ (isset($bill_of_lading) ? $bill_of_lading->total_cargo_type_id : "") }}',
        code: '{{ ((isset($bill_of_lading) and ($bill_of_lading->total_cargo_type_id > 0 ))? $bill_of_lading->total_cargo_type->name : "") }}'
    },onSelect:function(e,o){$("#total_cargo_type_id").val(e.id),$(this).val(e.code)},minChars:2,param:"term"}).on("marcopolorequestbefore",function(){$("#total_cargo_type_name_img").removeClass("img-none").addClass("img-display"),$("#total_cargo_type_name_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#total_cargo_type_name_img").removeClass("img-display").addClass("img-none"),$("#total_cargo_type_name_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#total_cargo_type_id").val(0)}).blur(function(){var e=$("#total_cargo_type_id").val();0==e&&($(this).val(""))});
    $("#service_name").marcoPolo({url:"{{ route('services.autocomplete') }}",formatItem:function(e,o){return e.name}, selected: {
        id: '{{ (isset($bill_of_lading) ? $bill_of_lading->service_id : "") }}',
        name: '{{ ((isset($bill_of_lading) and ($bill_of_lading->service_id > 0)) ? $bill_of_lading->service->name : "") }}',
        ...
        $("#destiny_country_name").marcoPolo({url:"{{ route('countries.autocomplete') }}",formatItem:function(e,o){return e.value},selected:{
            ...
            name: '{{ ((isset($bill_of_lading) and ($bill_of_lading->destiny_country_id > 0 ))? $bill_of_lading->destiny_country->name : "") }}',
        },onSelect:function(e,o){$("#destiny_country_id").val(e.id),$(this).val(e.value)},minChars:3,param:"term",required:!0}).on("marcopolorequestbefore",function(){$("#destiny_country_name_img").removeClass("img-none").addClass("img-display"),$("#destiny_country_name_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#destiny_country_name_img").removeClass("img-display").addClass("img-none"),$("#destiny_country_name_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#destiny_country_id").val(0)}).blur(function(){var e=$("#destiny_country_id").val();0==e&&($(this).val(""))});
    ...
    },onSelect: function(e, o) {$("#carrier_id").val(e.id), $(this).val(e.name)},minChars: 3,param: "term",required: !0}).on("marcopolorequestbefore", function() {
    ...
    $("#delivery_carrier_name").marcoPolo({url: "{{ route('carriers.autocomplete') }}",formatItem: function(e, o) {return  e.name},selected:{
        ...
        $("#agent_name").marcoPolo({url:"{{ route('customers.autocomplete') }}",formatItem:function(e,o){return e.value},selected:{
            ...
            value: '{{ ((isset($bill_of_lading) and ($bill_of_lading->agent_id > 0 ))? $bill_of_lading->agent->code : "") }}',
        ...
        $("#third_name").marcoPolo({url:"{{ route('customers.autocomplete') }}",formatItem:function(e,o){return e.value},selected:{
            ...
            value: '{{ ((isset($bill_of_lading) and ($bill_of_lading->third_id > 0 ))? $bill_of_lading->third->code : "") }}',
    ...
    $("#tmp_drop_type").change(function () {
        ...
        $("#ultimate_destination_name").marcoPolo({url:"{{ route('countries.autocomplete') }}",formatItem:function(e,o){return e.value},onSelect:function(e,o){$("#ultimate_destination_id").val(e.id),$(this).val(e.value)},minChars:3,param:"term",required:!0}).on("marcopolorequestbefore",function(){$("#ultimate_destination_name_img").removeClass("img-none").addClass("img-display"),$("#ultimate_destination_name_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#ultimate_destination_name_img").removeClass("img-display").addClass("img-none"),$("#ultimate_destination_name_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#ultimate_destination_id").val(0)}).blur(function(){var e=$("#ultimate_destination_id").val();0==e&&($(this).val(""))});
    ...
    $("#routing_order_code").marcoPolo({url: "{{ route('io_routing_order.autocomplete') }}",formatItem: function(e, o) {return  e.code},selected:{
        ...
        shipper_city: '{{ ((isset($bill_of_lading) and ($bill_of_lading->shipper_id >0))? $bill_of_lading->shipper->city : "" )  }}',
        ...
        consignee_city: '{{ ((isset($bill_of_lading) and ($bill_of_lading->consignee_id >0))? $bill_of_lading->consignee_city : "" )  }}',
