...
<div class="container-fluid">
                ...
                <tr>
                    ...
                    <td width="25%" colspan="2">
                        <table class="table header-table">
                            ...
                            <tr><td> {{ $bill_of_lading->date  }}</td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td width="25%">
                        <table class="table header-table">
                            ...
                            <tr><td> {{ $bill_of_lading->mbl_code  }}</td></tr>
                        </table>
                    </td>
                    <td width="25%" colspan="2">
                        <table class="table header-table">
        ...
        <div class="col-xs-12">
            <table class="table table-condensed">
                ...
                <tr>
                    <td height="50px">
                        @foreach($bill_of_lading->container as $detail)
                            <?php  echo nl2br( strtoupper($detail->container_number). "\n". strtoupper($detail->seal_number). "\n". strtoupper($detail->seal_number2)); ?>
                        @endforeach
                    </td>
                    <td>{{ $bill_of_lading->total_pieces }}</td>
                    <td></td>
                    <td>
                        {{ $bill_of_lading->total_gross_weight }} Lbs <br>
                        {{ round($bill_of_lading->total_gross_weight * 0.453592, 3) }} Kgs
                    </td>
                    <td>
                        {{ $bill_of_lading->total_cubic }} Cft <br>
                        {{ round($bill_of_lading->total_cubic * 0.028316, 3)}} Cbm<br>
                    </td>
                </tr>
                </tbody>
                <tfoot>
                <tr>
                    ...
                    <td><strong>
                        {{ $bill_of_lading->total_cubic }} Cft <br>
                        {{ round($bill_of_lading->total_cubic * 0.028316, 3) }} Cbm
                        </strong></td>
                </tr>
                </tfoot>
            </table>
    ...
    <div class="row">
        <div class="col-xs-12">
            <table class="table header-table">
                <tr>
                    <td width="10%" height="40px"><strong>COMMODITY:</strong></td>
                    <td>{{ strtoupper($bill_of_lading->total_commodity) }}</td>
                </tr>
                <tr>
