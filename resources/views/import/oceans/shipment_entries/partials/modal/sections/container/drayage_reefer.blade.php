...
<div class="row">
    ...
    <div class="col-md-4">{!! Form::bsSelect(null, null, 'Ventilation', 'container_ventilation', array('A' => 'A - 25%','B' => 'B - 50%','C' => 'C - 75%','D' => 'D - CLOSED','E' => 'E - 10%'), null) !!}</div>
    <div class="col-md-4">{!! Form::bsSelect(null, null, 'Degrees', 'container_degrees', array('F' => 'Fahrenheit','C' => 'Celsius'), null) !!}</div>
