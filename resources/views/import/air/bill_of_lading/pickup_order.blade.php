    ...
    <div class="row">
        <div class="table-content resume-table" style="height:280px; border-bottom: 1px solid;">
            ...
            <div class="table-row">
                ...
                <div class="cell adjust"></div>
                <div class="cell adjust">{{ round($bill_of_lading->total_pieces) }}</div>
                <div class="cell adjust">{{ strtoupper($bill_of_lading->mbl_code) }}</div>
                <div class="cell adjust">
                    @if($bill_of_lading->total_weight_unit == 'L')
                        {{ $bill_of_lading->total_gross_weight }} Lbs <br> {{ round($bill_of_lading->total_gross_weight * 0.453592, 3) }} Kgs
                    @else
                        {{ round($bill_of_lading->total_gross_weight * 2.2, 3) }} Lbs <br> {{ $bill_of_lading->total_gross_weight  }} Kgs
                    @endif
                </div>
            </div>
            <div class="table-row">
