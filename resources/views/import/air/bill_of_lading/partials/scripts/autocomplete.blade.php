    ...
    $("#routing_order_code").marcoPolo({url: "{{ route('ia_routing_order.autocomplete') }}",formatItem: function(e, o) {return  e.code},selected:{
        ...
        $("#routing_order_id").val(e.id), $("#routing_order_code").val(e.code).change(),
            $("#port_loading_id").val(e.port_loading_id),
                ...
                $("#carrier_name").val(e.carrier_name), $("#first_carrier").val(e.carrier_name), $("#port_unloading_code").val(e.port_unloading_code), $("#shipper_id").val(e.shipper_id), $("#shipper_name").val(e.shipper_name), $("#shipper_phone").val(e.shipper_phone), $("#shipper_fax").val(e.shipper_fax), $("#shipper_address").val(e.shipper_address), $("#shipper_city").val(e.shipper_city), $("#shipper_state_id").val(e.shipper_state_id), $("#shipper_state_name").val(e.shipper_state_name), $("#consignee_id").val(e.consignee_id), $("#consignee_name").val(e.consignee_name), $("#consignee_city").val(e.consignee_city), $("#consignee_phone").val(e.consignee_phone), $("#consignee_fax").val(e.consignee_fax), $("#consignee_address").val(e.consignee_address), $("#consignee_state_id").val(e.consignee_state_id), $("#consignee_state_name").val(e.consignee_state_name), $("#port_loading").val(e.port_loading_name), $("#port_unloading").val(e.port_unloading_name)
    },minChars: 3,
        param: "term"
    }).on("marcopolorequestbefore", function() {
        $("#routing_order_code_img").removeClass("img-none").addClass("img-display"), $("#routing_order_code_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter", function() {$("#routing_order_code_img").removeClass("img-display").addClass("img-none"), $("#routing_order_code_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#delivery_carrier_id").val(0)}).blur(function(){var e=$("#delivery_carrier_id").val();0==e&&($(this).val(""),  $("#port_loading_id").val(""), $("#port_unloading_id").val(""), $("#port_loading_name").val(""), $("#port_unloading_name").val(""),  $("#shipper_id").val(""), $("#shipper_name").val(""), $("#shipper_phone").val(""), $("#shipper_city").val(""), $("#shipper_fax").val(""), $("#shipper_address").val(""), $("#shipper_state_id").val(""), $("#shipper_state_name").val(""), $("#consignee_id").val(""), $("#consignee_name").val(""), $("#consignee_phone").val(""), $("#consignee_city").val(""), $("#consignee_fax").val(""), $("#consignee_address").val(""), $("#consignee_state_id").val(""), $("#consignee_state_name").val(""))});
