<div id="Pickup_Details" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Add Pickup Details</h4>
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-condensed" id="load_houses">
                    ...
                    <tr>
                        ...
                        <th width="15%" data-override="mbl_consignee_name">Carrier</th>
                        <th width="15%"></th>
            ...
            <div class="modal-footer">
                ...
                <a id="add_pickup" class="btn btn-primary btn-footer" href="javascript:void(0)">
