<div class="row">
    ...
    <div class="col-md-3">{!! Form::bsSelect(null, null, 'Unit', 'origin_bill_unit_id', Sass\Unit::all()->lists('code', 'id'), null ,'body', false) !!}</div>

    <div class="col-md-2">{!! Form::bsText(null, null, 'Increase %', 'origin_bill_increase', null, '0.000') !!}</div>
    <div class="col-md-1">{!! Form::bsText(null, null, 'Rate', 'origin_bill_rate', null, '0.000') !!}</div>
