<div class="row">
    ...
    <div class="col-md-2">{!! Form::bsText(null, null, 'Qty.', 'origin_bill_quantity', null, '0') !!}</div>
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Unit', 'origin_bill_unit_id', Sass\Unit::all()->lists('code', 'id'), 'UNIT' ,'body', false) !!}</div>
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Currency', 'origin_bill_currency_type',Sass\Currency::all()->lists('code', 'id'), '', 'body',false)
     !!}</div>
