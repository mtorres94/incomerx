        ...
        <div class="modal-content">
            <form id="ContainerModal" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">{!! Form::bsComplete(null, null, 'Equip. Type', 'tmp_equipment_type_id', 'tmp_equipment_type_code', Request::get('term'), null, 'Type') !!}</div>
                    ...
                    <div class="easyui-tabs" id="container_tabs">
                        <div title="Drayage/ Reefer">
                            @include('import.air.bill_of_lading.partials.modal.sections.container.drayage_reefer')
                        </div>
                        <div title="Pickup">
                            @include('import.air.bill_of_lading.partials.modal.sections.container.pickup')
                        </div>
                        <div title="Delivery">
                            @include('import.air.bill_of_lading.partials.modal.sections.container.delivery')
                        </div>
                        <div title="Drop">
                            @include('import.air.bill_of_lading.partials.modal.sections.container.drop')
                        </div>
