            ...
            <div class="modal-body" >
                ...
                <div id="cargo-tabs" class="easyui-tabs">
                    <div title="Mark & Descriptions">
                        @include('import.air.bill_of_lading.partials.modal.sections.cargo.mark_description')
                    </div>

                   <!-- <div title="Cargo Details">
                        @include('import.air.bill_of_lading.partials.modal.sections.cargo.warehouse')
                    </div>-->
                </div>

                <div class="row">
                    <div class="col-md-3">{!! Form::bsText(null,null, 'Loaded on Container', 'tmp_container', null, '') !!}</div>
                    <div class="col-md-4">{!! Form::bsComplete(null, null, 'Cargo Type', 'tmp_cargo_type_id',Sass\CargoType::all()->lists('code', 'id') ,'Type', 'body') !!}</div>
