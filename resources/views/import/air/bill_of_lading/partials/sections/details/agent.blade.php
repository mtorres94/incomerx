...
<div class="row">
    <div class="col-md-12">{!! Form::bsComplete('col-md-3', 'col-md-9','Agent ', 'agent_id', 'agent_name', Request::get('term'),((isset($bill_of_lading) and $bill_of_lading->agent_id > 0) ? $bill_of_lading->agent->name : null),'Name', null) !!}</div>
</div>
<div class="row">
    <div class="col-md-12">{!! Form::bsComplete('col-md-3', 'col-md-9','Third Party ', 'third_id', 'third_name', Request::get('term'),((isset($bill_of_lading) and $bill_of_lading->third_id > 0) ? $bill_of_lading->third->name : null),'Name', null) !!}</div>
</div>
