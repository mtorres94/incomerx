...
<div class="row row-padding">
    <div class="col-md-12">
        ...
        <div class="col-md-2">{{ Form::bsText(null, null, 'T Weight', 'total_weight', null) }}</div>
        <div class="col-md-2">{{ Form::bsText(null, null, 'Cubic', 'total_cubic', null) }}</div>
        <div class="col-md-2">{!! Form::bsSelect(null, null, 'Cargo Type', 'total_cargo_type_id', Sass\CargoType::all()->lists('code', 'id'), 'TYPE', 'body') !!}</div>
        <div class="col-md-3">{!! Form::bsText(null, null, 'Commodity', 'total_commodity_id', null) !!}</div>
