...
<div class="row">
    <div class="col-md-12">{!! Form::bsText('col-md-4', 'col-md-6', 'Phone', 'agent_phone',null) !!}</div>
</div>
<div class="row">
    <div class="col-md-8">{!! Form::bsText('col-md-6', 'col-md-6', 'Transit days', 'transit_day',null) !!}</div>
    <div class="col-md-4">{!! Form::bsSelect('col-md-4', 'col-md-8', 'Type', 'payment_type', array(
            '1' => '1- CHECK',
            '2' => '2- CC',
            '3' => '3- CASH',
            '4' => '4- WIRE',
