        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="charges-tabs" class="easyui-tabs">
                    <div title="Billing">
                        @include('warehouse.pickup.orders_entries.partials.modal.sections.charges.billing')
                    </div>
                    <div title="Cost">
                        @include('warehouse.pickup.orders_entries.partials.modal.sections.charges.cost')
                    </div>
                </div>
            </div>
