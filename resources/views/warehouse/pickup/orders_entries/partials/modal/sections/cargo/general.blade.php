<div class="row">
    <div class="col-md-6">
        ...
        {!! Form::hidden('cargo_location_name', null, ['id' => 'cargo_location_name', 'class' => 'form-control input-sm']) !!}
        <div class="col-md-3">{!! Form::bsText(null, null, 'Qty.', 'cargo_quantity', null, '0') !!}</div>
        <div class="col-md-5">{!! Form::bsSelect(null, null, 'Cargo Type', 'cargo_cargo_type_id',Sass\CargoType::all()->lists('code', 'id'), 'Cargo types', false) !!}</div>
