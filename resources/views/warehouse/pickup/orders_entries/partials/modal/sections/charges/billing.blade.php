<div class="row">
    ...
    <div class="col-md-1">{!! Form::bsSelect(null, null, 'Currency', 'billing_currency_type', Sass\Currency::all()->lists('code', 'id'), ' ')
     !!}</div>
    <div class="col-md-1">{!! Form::bsText(null, null, 'Xch', 'billing_exchange_rate', null, '0.00') !!}</div>
    <div class="col-md-12">{!! Form::bsComplete(null, null, 'Customer', 'billing_customer_id', 'billing_customer_name', Request::get('term'),null, 'Customers...') !!}</div>
</div>
