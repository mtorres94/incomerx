<div class="row ">
    {!! Form::hidden('charge_id', null, ['id' => 'charge_id', 'class' => 'form-control input-sm']) !!}
        ...
        <div class="col-md-2">{!! Form::bsText(null, null, 'Qty.', 'cost_quantity', null, '0') !!}</div>
        <div class="col-md-3">{!! Form::bsComplete(null, null, 'Unit', 'cost_unit_id', 'cost_unit_name',Request::get('term'),
   null, ' ') !!}</div>
        <div class="col-md-3">{!! Form::bsText(null, null, 'Rate', 'cost_rate', null, '0.000') !!}</div>
        <div class="col-md-2">{!! Form::bsText(null, null, 'Amount', 'cost_amount', null, '0.000') !!}</div>
</div>
<div class="row">
    <h4>Other Currency</h4>
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Currency', 'cost_currency_type', array('E' => 'EUR','U' => 'USD'), ' ')
     !!}</div>
    <div class="col-md-3">{!! Form::bsText(null, null, 'Exchange Rate', 'cost_exchange_rate', null, '0.00') !!}</div>
</div>
<div class="row">
