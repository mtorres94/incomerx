<div class="row ">
    {!! Form::hidden('cost_unit_name', null, ['id' => 'cost_unit_name', 'class' => 'form-control input-sm']) !!}
        ...
        <div class="col-md-2">{!! Form::bsSelect(null, null, 'Unit', 'cost_unit_id',Sass\Unit::all()->lists('code', 'id'), 'Units', false) !!}</div>
        ...
        <div class="col-md-2">{!! Form::bsSelect(null, null, 'Currency', 'cost_currency_type', Sass\Currency::all()->lists('code', 'id'), 'Currency')
     !!}</div>
    <div class="col-md-2">{!! Form::bsText(null, null, 'Exch. Rate', 'cost_exchange_rate', null, '0.00') !!}</div>
</div>
<div class="row">
