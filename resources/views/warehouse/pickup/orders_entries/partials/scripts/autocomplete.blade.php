...
<script type="text/javascript">
        ...
        $("#carriers_carrier_name").marcoPolo({
            ...
            selected:{
                ...
                name:'{{ ((isset($order_entry) and ($order_entry->carriers_carrier_id > 0 ))? $order_entry->carrier->name : "")}}',
            },
            onSelect: function(e, o) {
    ...
    $("#delivery_type").change(function () {
        ...
        $("#location_service_name").marcoPolo({url:"{{ route('services.autocomplete') }}",
            selected:{
                id: '{{ (isset($order_entry)? $order_entry->location_service_id: "") }}',
                name: '{{ ((isset($order_entry) and ($order_entry->location_service_id >0 ))? $order_entry->location_service->name : "") }}',
    ...
    $("#origin_to_type").change(function () {
        ...
        $("#transportation_billing_code").marcoPolo({url:"{{ route('billing_codes.autocomplete') }}",formatItem:function(e,o){return e.code + '|'+ e.value},onSelect:function(e,o){$("#transportation_billing_id").val(e.id),$(this).val(e.code), $("#transportation_description").val(e.value)},minChars:2,param:"term"}).on("marcopolorequestbefore",function(){$("#transportation_billing_code_img").removeClass("img-none").addClass("img-display"),$("#transportation_billing_code_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#transportation_billing_code_img").removeClass("img-display").addClass("img-none"),$("#transportation_billing_code_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#transportation_billing_code").val(0)}).blur(function(){var e=$("#transportation_billing_code").val();0==e&&$(this).val("")})
