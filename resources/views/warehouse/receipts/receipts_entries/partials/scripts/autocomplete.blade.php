...
<script type="text/javascript">
    ...
    $("#consignee_name").marcoPolo({
        ...
        $("#tmp_billing_vendor_name").marcoPolo({url:"{{ route('vendors.autocomplete') }}",formatItem:function(e,o){return e.name},onSelect:function(e,o){$("#tmp_billing_vendor_code").val(e.id),$(this).val(e.name)},minChars:3,param:"term",required:!0}).on("marcopolorequestbefore",function(){$("#tmp_billing_vendor_name_img").removeClass("img-none").addClass("img-display"),$("#tmp_billing_vendor_name_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#tmp_billing_vendor_name_img").removeClass("img-display").addClass("img-none"),$("#tmp_billing_vendor_name_spn").removeClass("img-none").addClass("img-display")}).keydown(function(e){var o=e.keyCode?e.keyCode:e.which;(8==o||46==o)&&$("#tmp_billing_vendor_id").val(0)}).blur(function(){var e=$("#tmp_billing_vendor_id").val()});
