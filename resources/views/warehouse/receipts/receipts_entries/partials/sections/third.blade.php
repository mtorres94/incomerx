<fieldset id="third_party_section">
    ...
    <div class="form-horizontal">
        <div class="row">
            {!! Form::bsComplete('col-md-3', 'col-md-9', 'Name', 'third_party_id', 'third_party_name', Request::get('term'), ((isset($wr_entry) and $wr_entry->third_party_id > 0) ? $wr_entry->third_party->name : null), 'Customers...') !!}
        </div>
        <div class="row">
