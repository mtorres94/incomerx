<div class="row">
    <div class="col-md-6">
        ...
        <div class="row row-panel">
            ...
            <div class="col-md-5">{!! Form::bsSelect(null, null, 'Cargo Type', 'multiline_cargo_type_id', Sass\CargoType::all()->lists('code', 'id'), 'CARGO TYPES', 'body',false) !!}</div>
...
<div class="row row-panel">
    ...
    <div class="col-md-3">{!! Form::bsSelect(null, null, 'Location', 'multiline_cargo_location_id', Sass\Location::all()->lists('code', 'id'), 'Location', 'body', false) !!}</div>
