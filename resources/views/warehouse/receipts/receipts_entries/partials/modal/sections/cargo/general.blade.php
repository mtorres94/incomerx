<div class="row">
    <div class="col-md-6">
        <div class="row row-panel">
            ...
            {!! Form::hidden('cargo_weight_unit_measurement_code', null, ['id' => 'cargo_weight_unit_measurement_code', 'class' => 'form-control input-sm']) !!}
            {!! Form::hidden('cargo_metric_unit_measurement_code', null, ['id' => 'cargo_metric_unit_measurement_code', 'class' => 'form-control input-sm']) !!}

            <div class="col-md-3">{!! Form::bsText(null, null, 'Qty.', 'cargo_quantity', null, '0') !!}</div>
            <div class="col-md-5">{!! Form::bsSelect(null, null, 'Cargo Type', 'cargo_type_id', Sass\CargoType::all()->lists('code', 'id'), 'CARGO TYPES', true) !!}</div>
            <div class="col-md-4">{!! Form::bsSelect(null, null, 'Inches/Cms', 'cargo_metric_unit_measurement_id', array('C' => 'CMS', 'I' => 'INCHES'), null) !!}</div>
    ...
    <div class="col-md-6">
        <div class="row row-panel">
            <div class="col-md-12">{!! Form::bsMemo(null, null, 'Material Descriptions', 'cargo_material_description', null, 3, '') !!}</div>
        </div>
    </div>
</div>
<div class="row row-panel">
    <div class="col-md-1">{!! Form::bsText(null, null, 'Pcs.', 'cargo_pieces', null, '0') !!}</div>
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Kgs/Lbs', 'cargo_weight_unit_measurement_id', array('K' => 'KGS', 'L' => 'LBS'), null) !!}</div>
    <div class="col-md-1">{!! Form::bsText(null, null, 'Weight', 'cargo_unit_weight', null, '0.000') !!}</div>
    <div class="col-md-2">{!! Form::bsText(null, null, 'Total Weight', 'cargo_total_weight', null, '0.000') !!}</div>
    <div class="col-md-2">{!! Form::bsText(null, null, 'Cubic', 'cargo_cubic', null, '0.000') !!}</div>
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'DIM Fact', 'cargo_dim_fact', array('D' => 'DOM', 'I' => 'INT'), null) !!}</div>
