<div class="row">
    <div class="col-md-6">
        <div class="row row-panel">
            ...
            <div class="col-md-5">{!! Form::bsSelect(null, null, 'Cargo Type', 'tmp_cargo_type_id', Sass\CargoType::all()->lists('code', 'id'), 'CARGO TYPES', true) !!}</div>
...
<div class="row row-panel">
    ...
    <div class="col-md-3">{!! Form::bsComplete(null, null, 'Location', 'tmp_cargo_location_id', 'tmp_cargo_location_name', Request::get('term'), null, 'Location...') !!}</div>
    <div class="col-md-3">{!! Form::bsComplete(null, null, 'Bin', 'tmp_cargo_location_bin_id', 'tmp_cargo_location_bin_name', Request::get('term'), null, 'Location bin...') !!}</div>
