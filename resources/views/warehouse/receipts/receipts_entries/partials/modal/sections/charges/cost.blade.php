<div class="row">
    ...
    <div class="col-md-2">{!! Form::bsComplete(null, null, 'Unit', 'cost_unit_id', 'cost_unit_name', Request::get('term'), null, null) !!}</div>
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Currency', 'cost_currency_type', Sass\Currency::all()->lists('code', 'id'), null)
     !!}</div>
    <div class="col-md-3">{!! Form::bsText(null, null, 'Exchange Rate', 'cost_exchange_rate', null, '') !!}</div>
</div>
<div class="row">
    <div class="col-md-6">{!! Form::bsComplete(null, null, 'Vendor', 'billing_vendor_code', 'billing_vendor_name', Request::get('term'), null, 'Vendors...') !!}</div>
