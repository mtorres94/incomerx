<div class="row">
    ...
    <div class="col-md-2">{!! Form::bsText(null, null, 'Qty.', 'tmp_billing_quantity', null, '0') !!}</div>
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Unit', 'tmp_billing_unit_id', Sass\Unit::all()->lists('code', 'id'), 'UNITS', 'body', false) !!}</div>
    ...
    <div class="col-md-1">{!! Form::bsSelect(null, null, 'Currency', 'tmp_billing_currency_type', Sass\Currency::all()->lists('code', 'id'), null)
     !!}</div>
