<div class="row">
    ...
    <div class="col-md-2">{!! Form::bsComplete(null, null, 'Unit', 'billing_unit_id', 'billing_unit_name', Request::get('term'), null, null) !!}</div>
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Currency', 'billing_currency_type', Sass\Currency::all()->lists('code', 'id'), null)
     !!}</div>
    <div class="col-md-2">{!! Form::bsText(null, null, 'Exchange Rate', 'billing_exchange_rate', null, '') !!}</div>
