                    ...
                    success: function (e) {
                        ...
                        while(e[x].id != ""){
                            ...
                            p.append(createTableContent('cargo_id',r, true, x))
                                    ...
                                    .append(createTableContent('details_total_weight', e[x].total_weight, false, x))
                ...
                for (c=0; c< whr_select.length ; c ++){
                    if(whr_select[c] == tr[a].childNodes[1].textContent){
                        ...
                        p_1.append(createTableContent('warehouse_id', whr_select[c], true, d))
                                ...
                                .append(createTableContent('sum_pieces', tr[a].childNodes[26].textContent, false, d))
                                .append(createTableContent('sum_weight', tr[a].childNodes[27].textContent, false, d))
                                .append(createTableContent('sum_cubic', tr[a].childNodes[28].textContent, false, d))
