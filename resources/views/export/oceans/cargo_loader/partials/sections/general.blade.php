<fieldset>
    ...
    <div class="row">
        ...
        <div class="col-md-3">{!! Form::bsComplete(null, null,'Booking # ', 'booking_id', 'booking_code', Request::get('term'),((isset($cargo_loader) and $cargo_loader->shipment_id > 0) ? $cargo_loader->shipment->shipment_code : null), '') !!}</div>
