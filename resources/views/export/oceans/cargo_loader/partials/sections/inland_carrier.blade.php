<div class="row">
    ...
    <div class="col-md-6">
        <div class="row">{!! Form::bsComplete('col-md-3', 'col-md-6', 'Inland Carrier', 'inland_carrier_id', 'inland_carrier_name', Request::get('term'), ((isset($cargo_loader) and $cargo_loader->inland_carrier_id > 0) ? $cargo_loader->inland_carrier->name : null), 'Carriers') !!}</div>
