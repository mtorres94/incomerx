            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-condensed" id="load_warehouses">
                    ...
                    <tr>
                        ...
                        <th width="15%" data-override="hbl_wr_number">#WR</th>
                        <th width="15%" data-override="hbl_date_in">Date in</th>
                        <th width="15%" data-override="hbl_shipper_name" >Shipper</th>
                        <th width="15%" data-override="hbl_consignee_name">Consignee</th>
                        <th width="15%" data-override="hbl_consignee_name">Container</th>
                        <th width="15%"></th>
