<script type="text/javascript">
    ...
    function show_alert(detail){
        swal({   title: "Error!",   text: "A required file is empty. Please complete it and try again.\nDetails:". detail,   type: "warning",   confirmButtonText: "Ok" });
    }
    ...
    function container_total(){
        var tr = $('#container_details tbody tr');
        var r = tr.length,  weight_k=0, cubic_k=0, pieces=0;
        for (var a=0; a< r ; a++){
        ...
        $("#total_quantity").val(pieces),
                ...
                $("#total_volume_weight").val(weight_k)
    }
