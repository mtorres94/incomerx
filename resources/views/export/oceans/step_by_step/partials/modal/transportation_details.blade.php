            ...
            <div class="modal-body">
                <div id="transportation-tabs" class="easyui-tabs">
                    ...
                    <div title="Transportation Details">
                        @include('export.oceans.step_by_step.partials.modal.sections.transportation.transportation_details')
                    </div>
                    <div title="Origin & Destinations">
                        @include('export.oceans.step_by_step.partials.modal.sections.transportation.origin_destination')
                    </div>
