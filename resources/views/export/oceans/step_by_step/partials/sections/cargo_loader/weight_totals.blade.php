...
<div class="row ">
    ...
    <div class="col-md-2">{!! Form::bsText(null,null, 'Vol. Weight', 'total_volume_weight', null, '0.000') !!}</div>
    <div class="col-md-3">{!! Form::bsComplete(null, null,'Cargo Type', 'total_cargo_type_id', 'total_cargo_type_code', Request::get('term'), ((isset($booking_entry) and $booking_entry->total_cargo_type > 0) ? $booking_entry->total_cargo_type->code : null), 'Type') !!}</div>
</div>
<div class="row">
    ...
    <div class="col-md-3">{!! Form::bsSelect(null, null, 'Freight Chrgs.', 'total_freight_charge',  array('C' => 'C - COLLECTED','P' => 'P - PREPAID' ), null)!!}</div>
    <div class="col-md-3">{!! Form::bsSelect(null, null, 'Other Chrgs', 'total_other_charge',  array('C' => 'C - COLLECTED','P' => 'P - PREPAID' ), null)!!}</div>
