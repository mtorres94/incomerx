<div class="btn-group btn-group-sm pull-right" role="group" style="padding-bottom: 10px;">
    ...
    <button type="button"  class="btn btn-default" data-toggle="modal" data-target="#Warehouse_Details" onclick="cleanModalFields('Warehouse_Details'), clearTable('warehouse_cargo_details')">
