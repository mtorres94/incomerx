<div class="row">
    <div class="col-md-12">
        ...
        {{ Form::bsDate('col-md-3', 'col-md-3', 'Date', 'quote_date', null) }}
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<div class="row">
    <div class="col-md-12">
        {!! Form::bsSelect('col-md-3', 'col-md-3', 'Type', 'type', array('C' => 'COLLECT','P' => 'PREPAID'), 'Type') !!}
        {!! Form::bsSelect('col-md-3', 'col-md-3', 'Bill Rate Class', 'rate_class', array('1' => '1 - 100 LB/ 1CFT', '2' => '2 - 2000 LB/ 40CFT', '3' => '3 - 1000 KG/ 1CBM', '4' => '4 - FIXED AMOUNT', '5' => '5 - CONTAINER', '6' => '6 - 50 LB/ 1CFT', '7' => '7 - OTHER'), null) !!}
    </div>
</div>
<div class="row">
    <div class="col-md-12">
