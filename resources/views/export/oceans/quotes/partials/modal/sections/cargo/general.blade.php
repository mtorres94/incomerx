<div class="row">
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Cargo Type', 'box_cargo_type_id', Sass\CargoType::all()->lists('code', 'id'),'Type', 'body', false) !!}</div>
...
<div class="row">
    ...
    <div class="col-md-1">{!! Form::bsSelect(null, null, 'Kgs/Lbs', 'box_weight_unit',  array('K' => 'KGS','L' => 'LBS' ), null)!!}</div>
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Dim Fact', 'box_dim_fact', array('I' => 'INT', 'D' => 'DOM'), ' ') !!}</div>
