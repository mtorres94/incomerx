    ...
    $("#broker_name").marcoPolo({url: "{{ route('customers.autocomplete') }}",formatItem: function(e, o) {return  e.value}, selected:{
        ...
        $("#quote_code").marcoPolo({url:"{{ route('quotes.autocomplete') }}",formatItem:function(e,o){return e.code},
            selected:{
                ...
                shipper_zip_code_code: '{{ ((isset($shipment_entry) and ($shipment_entry->shipper_zip_code_icode > 0 )) ? $shipment_entry->shipper_zip_code->code : "") }}',
                ...
                consignee_zip_code_code: '{{ ((isset($shipment_entry) and ($shipment_entry->consignee_zip_code_icode > 0 )) ? $shipment_entry->consignee_zip_code->code : "") }}',
