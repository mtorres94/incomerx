...
<html lang="en">
<head>
    <title>Shipment Entry {{ $shipment_entry->shipment_code }}</title>
    <meta charset="utf-8">
        ...
        <div class="col-xs-6">
            <div class="row">
                <div class="document-info pull-right">
                    <h5><strong>SHIPMENT ENTRY</strong></h5>
                    <p class="code-bar">{{ $shipment_entry->shipment_code }}</p>
                    <p class="document_number">{{ $shipment_entry->shipment_code }}</p>
                </div>
            </div>
        </div>
    </div>
