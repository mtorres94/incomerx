<script type="text/javascript">
    ...
    $("#booking_entry_code").focus(function () {
        $("#booking_entry_code").marcoPolo({url:"{{ route('booking_entries.autocomplete') }}",formatItem:function(e,o){return e.code},onSelect:function(e,o){
            $("#booking_entry_id").val(e.id),
                    $(this).val(e.code),
                    ...
                    $("#notify_fax").val(e.notify_fax),
                    $("#notify_state_id").val(e.notify_state_id),
                    $("#notify_state_name").val(e.notify_state_name),
                    $("#notify_country_id").val(e.notify_country_id),
                    $("#notify_country_name").val(e.notify_country_name),
                    $("#notify_zip_code_id").val(e.notify_zip_code_id),
                    $("#notify_zip_code_code").val(e.notify_zip_code_code)

        },
            minChars:2,param:"term",required:!0}).on("marcopolorequestbefore",function(){$("#booking_entry_code_img").removeClass("img-none").addClass("img-display"),$("#booking_entry_code_spn").removeClass("img-display").addClass("img-none")}).on("marcopolorequestafter",function(){$("#booking_entry_code_img").removeClass("img-display").addClass("img-none"),$("#booking_entry_code_spn").removeClass("img-none").addClass("img-display")}).on("marcopoloblur",function(){""==$(this).val().trim()&&($("#booking_entry_id").val(0),$("#booking_entry_code").val(""))})
    });
