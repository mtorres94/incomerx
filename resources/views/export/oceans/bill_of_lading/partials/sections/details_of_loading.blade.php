<div class="row">
    ...
    <div class="col-md-3"><p><b> Containerized (Vessel Only)</b></p>
        <div class="col-md-4">{!! Form::bsCheck('col-md-2', 'col-md-3','Yes', 'vessel_yes', (isset($bill_of_lading) ? $bill_of_lading->vessel_yes : 'off')) !!}</div>
        <div class="col-md-4">{!! Form::bsCheck('col-md-2', 'col-md-3','No', 'vessel_no', (isset($bill_of_lading) ? $bill_of_lading->vessel_no : 'off')) !!}</div>
    </div>
</div>
