...
<div class="row">
   {!! Form::bsComplete('col-md-3', 'col-md-9', 'Country Name', 'notify_country_id', 'notify_country_name', Request::get('term'), ((isset($bill_of_lading) and $bill_of_lading->notify_country_id > 0) ? $bill_of_lading->notify_country->name : null), 'Country') !!}
</div>
<div class="row">
