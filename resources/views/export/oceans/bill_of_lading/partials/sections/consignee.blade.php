<fieldset id="Consignee">
    ...
    <div class="row">
        {!! Form::bsComplete('col-md-3', 'col-md-9', 'Country Name', 'consignee_country_id', 'consignee_country_name', Request::get('term'), ((isset($bill_of_lading) and $bill_of_lading->consignee_country_id > 0) ? $bill_of_lading->consignee_country->name : null), 'Country') !!}
    </div>
    <div class="row">
