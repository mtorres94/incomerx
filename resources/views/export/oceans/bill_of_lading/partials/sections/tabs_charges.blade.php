            ...
            @if(isset($bill_of_lading))
                @foreach($bill_of_lading->transportation as $detail)
                    <tr id="{{ $detail->line }}">
                        ...
                        {!! Form::bsRowTd($detail->line, 'transportation_carrier_name', (($detail->carrier_id >0) ? $detail->carrier->name: null), false) !!}
                        {!! Form::bsRowTd($detail->line, 'transportation_loading_location_id', $detail->loading_location_id, true) !!}
                        {!! Form::bsRowTd($detail->line, 'transportation_loading_location_name', (($detail->loading_location_id >0) ? $detail->loading_location->name: null), false) !!}
                        {!! Form::bsRowTd($detail->line, 'transportation_unloading_location_id', $detail->unloading_location_id, true) !!}
                        {!! Form::bsRowTd($detail->line, 'transportation_unloading_location_name', (($detail->unloading_location_id >0) ? $detail->unloading_location->name: null), false) !!}
                        ...
                        {!! Form::bsRowTd($detail->line, 'transportation_billing_code', (($detail->billing_id >0) ? $detail->billing->code: null), true) !!}
                        ...
                        {!! Form::bsRowTd($detail->line, 'transportation_service_name',(($detail->service_id >0) ? $detail->service->name: null), true) !!}
                        ...
                        {!! Form::bsRowTd($detail->line, 'origin_from_shipper_name', (($detail->origin_from_shipper_id >0) ? $detail->origin_from_shipper->name: null), true) !!}
                        ...
                        {!! Form::bsRowTd($detail->line, 'origin_from_state_name', (($detail->origin_from_state_id >0) ? $detail->origin_from_state->name: null), true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_from_country_id', $detail->origin_from_country_id, true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_from_country_name', (($detail->origin_from_country_id >0) ? $detail->origin_from_country->name: null), true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_from_zip_code_id', $detail->origin_from_zip_code_id, true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_from_zip_code_code', (($detail->origin_from_zip_code_id >0) ? $detail->origin_from_zip_code->name: null), true) !!}
                        ...
                        {!! Form::bsRowTd($detail->line, 'origin_to_consignee_name', (($detail->origin_to_consignee_id >0) ? $detail->origin_to_consignee->name: null), true) !!}
                        ...
                        {!! Form::bsRowTd($detail->line, 'origin_to_state_name',  (($detail->origin_to_state_id >0) ? $detail->origin_to_state->name: null), true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_to_country_id', $detail->origin_to_country_id, true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_to_country_name',  (($detail->origin_to_country_id >0) ? $detail->origin_to_country->name: null), true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_to_zip_code_id', $detail->origin_to_zip_code_id, true) !!}
                        {!! Form::bsRowTd($detail->line, 'origin_to_zip_code_code',  (($detail->origin_to_zip_code_id >0) ? $detail->origin_to_zip_code->name: null), true) !!}
