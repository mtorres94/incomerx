...
<fieldset id="More details">
    ...
    <div class="row">
        {!! Form::bsText('col-md-3', 'col-md-9', 'Customs Code', 'customs_code', null, '') !!}
    </div>
    <div class="row">
            <div class="col-md-6">{!! Form::bsText('col-md-6', 'col-md-6', 'IT Number', 'it_number', null, '') !!}
        </div>
    ...
    <div class="row">
        <div class="col-md-6">{!! Form::bsText('col-md-6', 'col-md-6', 'Comm. (%)', 'commission_p', null, '') !!}</div>
    </div>
    <div class="row"> {!! Form::bsComplete('col-md-3', 'col-md-9','Co-Loader ', 'coloader_id', 'coloader_name', Request::get('term'),((isset($bill_of_lading) and $bill_of_lading->coloader_id > 0) ? $bill_of_lading->coloader->name : null), '') !!}
    </div>
...
<fieldset id="document_number">
    ...
    <div class="row">
        <div class="col-md-12">{!! Form::bsMemo(null, null, 'Export References', 'export_reference', null,2, '') !!}</div>
    </div>
    <div class="row">
        <div class="col-md-6">{!! Form::bsText(null, null, 'Point (state) of origin', 'point_of_origin', null, '') !!}</div>
