            ...
            <div class="modal-body">
                <div id="transportation-tabs" class="easyui-tabs">
                    ...
                    <div title="Transportation Details">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.transportation.transportation_details')
                    </div>
                    <div title="Origin & Destinations">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.transportation.origin_destination')
                    </div>
