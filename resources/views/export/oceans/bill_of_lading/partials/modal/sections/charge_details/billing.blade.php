<div class="row">
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Unit', 'billing_unit_id',Sass\Unit::all()->lists('code', 'id'),  null, 'body',false) !!}</div>
    ...
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Currency', 'billing_currency_type',Sass\Currency::all()->lists('code', 'id'), ' ')
     !!}</div>
    <div class="col-md-1">{!! Form::bsText(null, null, 'Xch R.', 'billing_exchange_rate', null, '0.00') !!}</div>
