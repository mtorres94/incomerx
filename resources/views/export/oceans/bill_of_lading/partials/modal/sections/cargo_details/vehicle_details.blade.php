    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close"  onclick='$("#Vehicle_Details").modal("hide")'>&times;</button>
                <h4 class="modal-title">New Vehicle Details</h4>
            </div>
            <div class="modal-body">
                <div class="easyui-tabs" id="vehicle-tabs">
                    <div title="Vehicle">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.cargo_details.vehicle_details.vehicle')
                    </div>
                    <div title="General">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.cargo_details.vehicle_details.general')
                    </div>
                    <div title="EEI Info">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.cargo_details.vehicle_details.eei_info')
                    </div>
                </div>
                <div class="row">
