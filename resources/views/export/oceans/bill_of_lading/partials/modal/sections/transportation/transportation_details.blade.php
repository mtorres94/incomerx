<div class="row">
    <div class="col-md-1">{!! Form::bsText(null, null, 'Leg', 'transportation_leg', null, '0') !!}</div>
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Mode', 'transportation_mode', array('A' => 'AIR','O' => 'OCEAN','T' => 'TRUCK'), ' ')!!}</div>
    <div class="col-md-3">{!! Form::bsComplete(null, null, 'Billing Code', 'transportation_billing_id', 'transportation_billing_code',  Request::get('term'), null, 'Billing codes...') !!}</div>
    <div class="col-md-3">{!! Form::bsText(null, null, 'Description', 'transportation_description', null, ' ') !!}</div>
    <div class="col-md-1">{!! Form::bsText(null, null, 'Amount', 'transportation_amount', null, '0.000') !!}</div>
    <div class="col-md-2">{!! Form::bsSelect(null, null, 'Leg Status', 'transportation_leg_status', array('O' => 'OPEN','B' => 'BOOKED','C' => 'COMPLETED'), ' ')!!}</div>
</div>
