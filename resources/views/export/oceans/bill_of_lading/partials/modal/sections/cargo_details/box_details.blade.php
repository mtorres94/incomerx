    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close"  onclick='$("#Box_Details").modal("hide")'>&times;</button>
            ...
            <div class="modal-body">
                ...
                <div class="easyui-tabs" id="box-tabs">
                    <div title="General">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.cargo_details.box_details.general')
                    </div>
                    <div title="Part Info">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.cargo_details.box_details.part_info')
                    </div>
                    <div title="EEI Info">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.cargo_details.box_details.eei_info')
                    </div>
                    <div title="Hazardous">
                        @include('export.oceans.bill_of_lading.partials.modal.sections.cargo_details.box_details.hazardous')
                    </div>
                </div>
                <div class="row">
