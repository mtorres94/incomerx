<div class="form-horizontal">
    ...
    <div class="pull-right" style="padding-bottom: 15px;">
        <div class="btn-group" role="group" aria-label="...">
            <a type="button" class="btn btn-default btn-sm" id="btn-pick-cargo" onclick="cleanModalFields('PickCargo')" data-toggle="modal" data-target="#PickCargo"><span>Pick Cargo</span></a>
        </div>
    </div>
