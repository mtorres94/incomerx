<fieldset id="state_of_origin">
    <div class="row">
        <div class="col-md-6">
            <legend>Point (State) of Origin</legend>
            <div class="row">{!! Form::bsText(null, "col-md-8", '', 'state_of_origin', null, null) !!}</div>
           <legend>Notify</legend>
            ...
            <div class="row">
                {!! Form::bsComplete('col-md-3', 'col-md-9', 'State/ Province', 'notify_state_id', 'notify_state_name', Request::get('term'), ((isset($booking_entry) and $booking_entry->notify_state_id > 0) ? $booking_entry->notify_state->name : null), 'State') !!}
            </div>
            <div class="row">
                {!! Form::bsComplete('col-md-3', 'col-md-9', 'Country Name', 'notify_country_id', 'notify_country_name', Request::get('term'), ((isset($booking_entry) and $booking_entry->notify_country_id > 0) ? $booking_entry->notify_country->name : null), 'Country') !!}
            </div>
            <div class="row">
                {!! Form::bsComplete('col-md-3', 'col-md-9', 'Zip Postal Code', 'notify_zip_code_id', 'notify_zip_code_code', Request::get('term'), ((isset($booking_entry) and $booking_entry->notify_zip_code_id > 0) ? $booking_entry->notify_zip_code->code : null), 'Zip Code') !!}
            </div>
            <div class="row">
