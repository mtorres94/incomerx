<fieldset id="destination">
    ...
    <div class="row">{!! Form::bsComplete("col-md-3", "col-md-9",'Port of Unloading ', 'port_unloading_id', 'port_unloading_name', Request::get('term'),((isset($booking_entry) and $booking_entry->port_unloading_id > 0) ? $booking_entry->port_unloading->name : null), 'Ports') !!}</div>
    <div class="row"> {!! Form::bsComplete("col-md-3", "col-md-9",'Place of delivery', 'place_delivery_id', 'place_delivery_name', Request::get('term'),((isset($booking_entry) and $booking_entry->place_delivery_id > 0) ? $booking_entry->place_delivery->name : null), 'World Location') !!}</div>
