<fieldset id="Origin">
    ...
    <div class="row">
        {!! Form::bsComplete("col-md-3", "col-md-9",'Place of receipt ', 'place_receipt_id', 'place_receipt_name', Request::get('term'),((isset($booking_entry) and $booking_entry->place_receipt_id> 0) ? $booking_entry->receipt->name : null), 'World Location') !!}
    </div>
    <div class="row">   {!! Form::bsComplete("col-md-3", "col-md-9",'Port of Loading ', 'port_loading_id', 'port_loading_name', Request::get('term'),((isset($booking_entry) and $booking_entry->port_loading_id > 0) ? $booking_entry->loading->name : null), 'Ports') !!}
    </div>
