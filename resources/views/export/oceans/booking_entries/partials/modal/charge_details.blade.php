        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="charges-tabs" class="easyui-tabs">
                    <div title="Billing">
                        @include('export.oceans.booking_entries.partials.modal.sections.charges.billing')
                    </div>
                    <div title="Cost">
                        @include('export.oceans.booking_entries.partials.modal.sections.charges.cost')
                    </div>
                </div>
            </div>
