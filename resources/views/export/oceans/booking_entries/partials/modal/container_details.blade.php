                ...
                <div class="row">
                    ...
                    <div class="easyui-tabs" id="container_tabs">
                        <div title="Drayage/ Reefer">
                            @include('export.oceans.booking_entries.partials.modal.sections.container.drayage_reefer')
                        </div>
                        <div title="Pickup">
                            @include('export.oceans.booking_entries.partials.modal.sections.container.pickup')
                        </div>
                        <div title="Delivery">
                            @include('export.oceans.booking_entries.partials.modal.sections.container.delivery')
                        </div>
                        <div title="Drop">
                            @include('export.oceans.booking_entries.partials.modal.sections.container.drop')
                        </div>
                        <div title="Hazardous">
                            @include('export.oceans.booking_entries.partials.modal.sections.container.hazardous')
                        </div>
                        <div title="Inner/Outer">
                            @include('export.oceans.booking_entries.partials.modal.sections.container.inner_outer')
                        </div>
                        <div title="Comments">
                            @include('export.oceans.booking_entries.partials.modal.sections.container.comments')
                        </div>
                    </div>
            </div>
