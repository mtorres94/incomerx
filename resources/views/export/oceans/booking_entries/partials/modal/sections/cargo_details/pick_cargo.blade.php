<div id="PickCargo" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="pick-tabs" class="easyui-tabs">
                    <div title="Cargo">
                        <table class="table table-bordered table-condensed" id="pick_cargo_details">
                            <thead>
                            <tr>
            ...
            <div class="modal-footer">
                <a class="btn btn-default btn-footer" onclick='$("#PickCargo").modal("hide")'>
