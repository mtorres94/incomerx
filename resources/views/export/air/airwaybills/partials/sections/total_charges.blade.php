...
<div class="col-md-6">
    <div class="row">{!! Form::bsMemo('col-md-3', 'col-md-9','Letter of Credit Comments', 'credit_comments', null, 3, '') !!}</div>
    <div class="row">{!! Form::bsMemo('col-md-3', 'col-md-9','Comments', 'airwaybill_comments', null, 3, '') !!}</div>
</div>
