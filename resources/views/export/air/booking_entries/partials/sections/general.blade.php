...
{!! Form::hidden('awb_number_id', null, ['id' => 'awb_number_id', 'class' => 'form-control input-sm']) !!}
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row">{!! Form::bsSelect('col-md-3', 'col-md-9', 'AWB Type', 'type', array('1' => 'INTERNATIONAL','2' => 'DOMESTIC'), '') !!}</div>
